...
<div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="username" placeholder="Masukkan username" id="username" class="form-control">
