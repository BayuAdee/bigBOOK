    ...
    <form action="" method="get">
        ...
        <div class="row">
            <div class="col">
                ...
                <p>Klik edit jika ingin perpanjang peminjaman</p>
...
<div class="card">
        ...
        <div class="form-group">
            <p>Apakah anda ingin memperpanjang peminjaman?</p>
            <p>Klik edit jika ingin perpanjang peminjaman</p>
        </div>
    ...
    <!-- <div class="kartu" style="margin:20px;">
        <h5 class="card-header">Form Peminjaman</h5> -->
        ...
        <label for="radioOption1">Saya ingin perpanjang</label>
        <input type="radio" name="radioGroup" value="Bagus kamu ga plin-plan" id="radio2490" />
        <label for="radioOption2">Saya tidak ingin perpanjang peminjaman</label>
        <p id="outputRadio">pilih salah satu</p>
        <button class="btn btn-light" id="kirim490">Kirim</button> -->
